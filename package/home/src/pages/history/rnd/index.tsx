...
export const RndHistory = () => {
  const dispatch = useAppDispatch();

  /** Hook */
  const { historyList, insertHistory, deleteHistory, formatDate } = useHistory('RND');

  /** 확장 상태 */
  const [expandedId, setExpandedId] = useState<number | null>(null);

  const openRegister = () => {
    dispatch(modalOpen(<Register onClick={insertHistory} catagory="RND" />));
  };
  ...
  return (
    ...
    >
      ...
      >
        <SjText renderType="title" text="R&D History" />
